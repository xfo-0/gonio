local ts = require("gonio.treesitter")
...
function M.invert_color(color)
  local hsluv = require("gonio.hsluv")
  if color ~= "NONE" then
...
function M.onColorScheme()
  vim.cmd([[autocmd! gonio]])
  vim.cmd([[augroup! gonio]])
end
...
function M.autocmds(config)
  vim.cmd([[augroup gonio]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("gonio.util").onColorScheme()]])
...
function M.terminal(colors)
  ...
  vim.g.terminal_color_4 = colors.brown2
  vim.g.terminal_color_12 = colors.brown2

  vim.g.terminal_color_5 = colors.magenta
  vim.g.terminal_color_13 = colors.magenta

  vim.g.terminal_color_6 = colors.orange1
  vim.g.terminal_color_14 = colors.orange1
end
